...
// It does NOT see: a class assembled at runtime from non-constant pieces, a
// `cva`/`clsx` variant map keyed by a lowercase local, a control built from a
// lowercase-named wrapper component, or a hairline reaching a control through a
// CSS class rather than a Tailwind utility. It is a net with known holes, not a
// proof — but it closes the hole this diff fell into, cheaply, at source level.
