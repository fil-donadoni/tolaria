...
export default function PlayerLife({ player }: PlayerLifeProps) {
    ...
    return (
        <div
            ...
            className={`bg-slate-900 text-white text-center px-3 py-2 rounded-md shrink-0 ${priorityRing} ${isTargetable ? "ring-2 ring-orange-400 cursor-pointer hover:ring-orange-300" : ""}`}
            onClick={handleClick}
        >
