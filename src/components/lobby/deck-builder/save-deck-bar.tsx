...
export default function SaveDeckBar({
    ...
    return (
        <form
            ...
            // enough to drop #2585's own ≥60% floor (measured 60.3% ->
            // 59.7% without this trim). Trimming this band's own padding by
            // 8px in the SAME `deck-source-dock:` context reclaims more
            // than that 4px back, net positive (measured 60.3% -> 60.5%
