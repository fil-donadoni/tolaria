 ...
 *    action-sheet. On DESKTOP, the left click is a no-op (the right-click
 *    context menu is the desktop path), mirroring the classic board so a
 *    permanent with both a tap and an ability is never tapped by a stray click;
...
export function useAbilityCardClick(
    ...
    const onClick = useCallback(
        (e: React.MouseEvent) => {
            ...
            // opens the ability menu — matching the classic board. The card's
