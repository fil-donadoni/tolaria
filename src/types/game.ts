...
export interface CardInstance {
     ...
     *  `chosenModeId`; read by the card preview so the permanent's oracle text
     *  can name the card actually chosen. Mirrors `CardInstanceState.chosenName`
     *  in `convex/gre/state.ts`. */
    chosenName?: string;
