...
const DRAW_PRIMITIVE_ALLOWLIST: readonly AllowlistEntry[] = [
    ...
    },
    {
        file: "c19/red.ts",
        count: 1,
        cards: "Anje's Ravager",
        reason: '"discard your hand" has no whole-hand discard selector Op.',
        classification: "planned-migratable",
        issue: 1279,
    },
    {
    ...
    },
    {
        ...
        count: 1,
        cards: "Timetwister",
        reason: '"shuffles hand and graveyard into library" is a bulk whole-zone move; moveZone only moves an announced target or a choice-picked set, never an entire zone.',
        classification: "planned-migratable",
        issue: 1279,
    },
    {
        ...
        reason: '"discards their hand" is a bulk whole-hand discard; the discard Op only discards a bound pick set.',
        classification: "planned-migratable",
        issue: 1279,
    },
    {
    ...
    },
    {
        ...
        reason: '"shuffles the cards from their hand into their library" is a bulk whole-hand-zone move; same gap as Timetwister.',
        classification: "planned-migratable",
        issue: 1279,
    },
    {
        ...
        count: 1,
        cards: "Echo of Eons",
        reason: "same bulk whole-zone-move gap as Timetwister (identical resolve() body).",
        classification: "planned-migratable",
        issue: 1279,
    },
    {
    ...
    },
    {
        ...
        count: 1,
        cards: "Memory Jar",
        reason: "compound protocol card (pre-existing): whole-hand face-down exile has no Op, exileFaceDown has no Op skin, and the per-player list-valued delayedTrigger capture the return trigger needs has no capture shape.",
        classification: "protocol",
    },
    {
        file: "voc/blue.ts",
