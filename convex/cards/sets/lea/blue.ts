...
// infrastructure (CR 700.2) is not implemented yet, so the resolve toggles (tracked-by: #2785)
...
// the mana lost this way." Simplified model: tap all target's lands, drain (tracked-by: #2785)
