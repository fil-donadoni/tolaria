...
// counters and each land that had one becomes a Forest." (Simplified from (tracked-by: #2785)
...
//
// Eligibility simplification: the card reads "creature card whose mana cost (tracked-by: #2785)
