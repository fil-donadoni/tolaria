...
// simplifies to "Search your library for a card, put it into your hand, then (tracked-by: #2785)
...
export const drainLife: CardDefinition = {
    ...
    // unmodelled in the closure (same simplification as Soul Burn); the migration (tracked-by: #2785)
