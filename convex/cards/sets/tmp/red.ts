...
//
// Price of Progress is an Exodus card (no Tempest printing) — the id is its
// real EXO print id, while the card lives in the tmp module because the home
// directory drives Premodern legality (Tempest block, PRD #979), following the
// Powder Keg precedent (issue #997).
