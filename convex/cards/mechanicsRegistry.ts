...
export const EFFECT_OP_BACKLOG: EffectOpRow[] = [
    ...
    // Goblin Artisans (single win/loss, no loop) shipped its synchronous flip
    // via the sibling `coinFlipSync` Op instead (issue #1281, see its own
    // EFFECT_OP_REGISTRY row above). Mijae Djinn / Ydwen Efreet DO use this same `requestCoinFlip`
