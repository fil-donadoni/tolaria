...
function costRecord(item: StackItem) {
    return {
        ...
        targetAmounts: item.targetAmounts,
        modeTargetCounts: item.modeTargetCounts,
        splicedCardIds: item.splicedCardIds,
        notedManaSpent: item.notedManaSpent,
        dynamicCantBeCountered: item.dynamicCantBeCountered,
        dynamicHasteFromMana: item.dynamicHasteFromMana,
