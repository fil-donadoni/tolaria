...
import { backFaceAsTokenSpec } from "../cards/backFaceSpec";
import { resolveTokenStaticEffects } from "../cards/tokenStaticEffects";
import type { CardBackFace, ManaCost } from "../cards/types";
import {
    isModalDoubleFaced,
    isPermanentTypeLine,
...
function registerBackFaceDefinition(backFace: CardBackFace): string {
    ...
    registerTokenDefinition({
        ...
        ...(spec.activatedAbilities
            ...
            : {}),
        // CR 712.8e (issue #3249) — the back face's own triggered abilities,
        // closures intact (this registration runs in the process that holds
        // the printed card).
