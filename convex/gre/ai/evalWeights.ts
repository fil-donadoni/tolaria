...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 4.965742,
    manaWeight: 11.112842,
    tappedManaWeight: 10.112842,
    manaDevWeight: 9.127569,
    flexWeight: 5.87755,
    deckingWeight: 1.5,
    graveyardEngineWeight: 68.352827,
    graveyardReachFraction: 0.200712,
    latent: Object.freeze({
        damage: 20.899266,
        cardAdvantage: 38.029342,
        lifeSwing: 7.674126,
        boardRemoval: 114.961333,
        ramp: 11.545028,
        evasion: 40,
        tempo: 55,
        disruption: 91.654879,
        recursion: 140,
        tokens: 0.478342,
        pump: 7.891783,
        protection: 56.600702,
    }),
});
