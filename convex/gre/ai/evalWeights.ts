...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 4.963481,
    manaWeight: 11.105637,
    tappedManaWeight: 10.105637,
    manaDevWeight: 9.512479,
    flexWeight: 5.863606,
    deckingWeight: 1.5,
    graveyardEngineWeight: 68.523864,
    graveyardReachFraction: 0.20045,
    latent: Object.freeze({
        damage: 20.89013,
        cardAdvantage: 38.065742,
        lifeSwing: 7.674294,
        boardRemoval: 114.983975,
        ramp: 11.545837,
        evasion: 40,
        tempo: 55,
        disruption: 91.839896,
        recursion: 140,
        tokens: 0.479928,
        pump: 7.897676,
        protection: 56.620149,
    }),
});
