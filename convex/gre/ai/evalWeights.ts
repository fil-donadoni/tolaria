...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 5.022677,
    manaWeight: 11.161801,
    tappedManaWeight: 10.161801,
    finiteManaUseWeight: 4.016767,
    manaDevWeight: 9.907366,
    colorCoverageWeight: 27.987803,
    flexWeight: 5.853318,
    deckingWeight: 1.5,
    graveyardEngineWeight: 66.145962,
    graveyardReachFraction: 0.197725,
    latent: Object.freeze({
        damage: 20.941197,
        cardAdvantage: 38.461623,
        lifeSwing: 7.691865,
        boardRemoval: 111.018298,
        ramp: 11.570149,
        evasion: 40,
        tempo: 55,
        disruption: 93.742563,
        recursion: 140,
        tokens: 0.496508,
        pump: 7.958776,
        protection: 56.816136,
    }),
});
