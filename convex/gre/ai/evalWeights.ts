...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 5.284989,
    manaWeight: 11.703933,
    tappedManaWeight: 10.703933,
    manaDevWeight: 11.483654,
    colorCoverageWeight: 26.371885,
    flexWeight: 5.856356,
    deckingWeight: 1.5,
    graveyardEngineWeight: 65.890076,
    graveyardReachFraction: 0.194652,
    latent: Object.freeze({
        damage: 20.959649,
        cardAdvantage: 38.896514,
        lifeSwing: 7.707598,
        boardRemoval: 114.370048,
        ramp: 11.592705,
        evasion: 40,
        tempo: 55,
        disruption: 95.903983,
        recursion: 140,
        tokens: 0.515557,
        pump: 8.027319,
        protection: 57.031219,
    }),
});
