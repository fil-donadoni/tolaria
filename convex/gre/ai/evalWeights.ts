...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 4.996729,
    manaWeight: 11.169378,
    tappedManaWeight: 10.169378,
    finiteManaUseWeight: 4.017041,
    manaDevWeight: 9.878581,
    colorCoverageWeight: 28.047738,
    flexWeight: 5.851472,
    deckingWeight: 1.5,
    graveyardEngineWeight: 66.230735,
    graveyardReachFraction: 0.198439,
    latent: Object.freeze({
        damage: 20.924806,
        cardAdvantage: 38.357949,
        lifeSwing: 7.686939,
        boardRemoval: 110.359209,
        ramp: 11.563481,
        evasion: 40,
        tempo: 55,
        disruption: 93.243435,
        recursion: 140,
        tokens: 0.492137,
        pump: 7.942794,
        protection: 56.765266,
    }),
});
