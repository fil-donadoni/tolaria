...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 4.996752,
    manaWeight: 11.164508,
    tappedManaWeight: 10.164508,
    finiteManaUseWeight: 4.016857,
    manaDevWeight: 9.898133,
    colorCoverageWeight: 28.008339,
    flexWeight: 5.8527,
    deckingWeight: 1.5,
    graveyardEngineWeight: 66.173316,
    graveyardReachFraction: 0.197961,
    latent: Object.freeze({
        damage: 20.93556,
        cardAdvantage: 38.42776,
        lifeSwing: 7.690215,
        boardRemoval: 110.801587,
        ramp: 11.567948,
        evasion: 40,
        tempo: 55,
        disruption: 93.577701,
        recursion: 140,
        tokens: 0.495063,
        pump: 7.953503,
        protection: 56.799691,
    }),
});
