...
export const DEFAULT_EVAL_WEIGHTS: Readonly<EvalWeights> = Object.freeze({
    ...
    lifeWeight: 8,
    permanentWeight: 5.020249,
    manaWeight: 11.223352,
    tappedManaWeight: 10.223352,
    manaDevWeight: 9.679412,
    colorCoverageWeight: 26.419658,
    flexWeight: 5.850319,
    deckingWeight: 1.5,
    graveyardEngineWeight: 66.40979,
    graveyardReachFraction: 0.198927,
    latent: Object.freeze({
        damage: 20.921355,
        cardAdvantage: 38.287103,
        lifeSwing: 7.684379,
        boardRemoval: 115.584351,
        ramp: 11.559747,
        evasion: 40,
        tempo: 55,
        disruption: 92.902962,
        recursion: 140,
        tokens: 0.489161,
        pump: 7.931862,
        protection: 56.72963,
