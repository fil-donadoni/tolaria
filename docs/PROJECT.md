...
sbagliato ed era irraggiungibile per costruzione, dato che ogni carta
correttamente marcata resta nel conteggio per sempre. Il drenaggio del bucket
FREE è passato al compilatore Oracle (#2703, PRD #2693), che ricompila le
closure dal testo Oracle e ritira quelle provate equivalenti. Lo strumento è
