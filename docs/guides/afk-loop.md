...
| `claims-held`  | a [pass](#g-pass) claimed work and landed nothing — likely killed mid-batch                  | `bun run loop:doctor --release` to drop `in-progress` on what it was holding, then resume |
