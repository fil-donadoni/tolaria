...
- **A site the branch added of a line the widening uncovered.** The entry
  takes the smaller of the two trees' counts; the extra site reds as
  `new-sites` until confirmed.
